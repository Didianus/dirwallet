...
export function SettingsView() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Nama Aplikasi</p>
                  </div>
                </div>
                <span className="text-sm font-semibold text-foreground">FinWallet</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Dibuat Dengan</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Lisensi</p>
                  </div>
                </div>
      ...
      >
        <p>&copy; {new Date().getFullYear()} FinWallet. All rights reserved.</p>
