          ...
          <div className="p-8">
            <AnimatePresence mode="wait">
              {isLogin ? (
                ...
                >
                  <div className="space-y-2">
                    <Label htmlFor="register-name" className="text-white/70 text-xs">
                      Full Name
                    </Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-email" className="text-white/70 text-xs">
                      Email
                    </Label>
                    <div className="relative">
                      <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-password" className="text-white/70 text-xs">
                      Password
                    </Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-confirm-password" className="text-white/70 text-xs">
                      Confirm Password
                    </Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
