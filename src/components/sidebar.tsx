...
const navItems: { view: ActiveView; label: string; icon: React.ElementType; adminOnly?: boolean }[] = [
    ...
    <>
      ...
      <div className="flex items-center justify-between p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white tracking-tight">FinWallet</h1>
            <p className="text-[10px] text-emerald-400/80 font-medium uppercase tracking-widest">Smart Finance</p>
          </div>
        </div>
        <Button
          variant="ghost"
