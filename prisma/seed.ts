...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: "admin@dirwallet.com" },
    update: {},
    create: {
      email: "admin@dirwallet.com",
      name: "Admin dirWallet",
  ...
  const demoUser = await prisma.user.upsert({
    where: { email: "user@dirwallet.com" },
    update: {},
    create: {
      email: "user@dirwallet.com",
      name: "Demo User",
    ...
    const transactions = [
      {
        ...
        categoryId: incomeCats.find((c) => c.name.includes("Gaji"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Makanan"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Transportasi"))!
          .id,
      ...
      },
      {
        ...
        categoryId: incomeCats.find((c) => c.name.includes("Bonus"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Belanja"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Tagihan"))!.id,
      ...
      },
      {
        ...
        categoryId: incomeCats.find((c) => c.name.includes("Freelance"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Hiburan"))!.id,
      ...
      },
      {
        ...
        categoryId: expenseCats.find((c) => c.name.includes("Kesehatan"))!.id,
      ...
      },
      {
        ...
        categoryId: incomeCats.find((c) => c.name.includes("Investasi"))!.id,
  ...
  if (demoUser.wallet) {
    ...
    const transactions = [
      ...
      },
      {
        type: "income",
        amount: 800000,
        description: "Project side hustle",
        categoryId: incomeCats.find((c) => c.name.includes("Freelance"))!.id,
  ...
  console.log("   Admin: admin@dirwallet.com / admin123");
  console.log("   User:  user@dirwallet.com / user123");
}
